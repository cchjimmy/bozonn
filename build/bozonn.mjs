...
var require_activationFns = __commonJS({
  "src/activationFns.js"(exports, module) {
    function identity(x) {
      return x;
    }
    function sigmoid(x) {
...
var require_outputProcessFns = __commonJS({
  "src/outputProcessFns.js"(exports, module) {
...
var require_optimizers = __commonJS({
  "src/optimizers.js"(exports, module) {
